...
import { Avatar, Button, Card, Carousel, Col, Divider, Drawer, Form, Input, message, Modal, Popconfirm, Row, Skeleton, Space, Typography, Upload, UploadFile, UploadProps } from "antd";
    ...
    return (
        data && (
            <>
                ...
                <Modal
                    open={openDrawer} // hoặc visible={openDrawer} nếu dùng phiên bản cũ
